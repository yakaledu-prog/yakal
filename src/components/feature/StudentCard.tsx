    ...
    <div className="student-card bg-white dark:bg-[#202c33] border border-[#e9edef] dark:border-[#2a3942] rounded-2xl p-5 shadow-sm">
      <div className="student-card__head flex items-center gap-4 mb-4">
        ...
        <div className="min-w-0">
          <h3 className="text-[16px] font-medium text-[#111] dark:text-white truncate">{s.full_name}</h3>
      ...
      <div className="student-card__stats grid grid-cols-2 gap-3 mb-4">
        <div className="bg-[#f8f9fa] dark:bg-[#182329] rounded-lg p-3">
          <p className="text-[20px] font-medium text-[#111] dark:text-white leading-none">{s.sessionCount}</p>
          <p className="text-[12px] text-[#54656f] dark:text-[#aebac1] mt-1">Sessions ({s.completedCount} done)</p>
        </div>
        <div className="bg-[#f8f9fa] dark:bg-[#182329] rounded-lg p-3">
          <p className="text-[14px] font-medium text-[#111] dark:text-white leading-tight">{formatDate(s.lastDate)}</p>
      ...
      <button
        ...
        className="student-card__message w-full flex items-center justify-center gap-2 h-10 rounded-lg border border-[#e9edef] dark:border-[#2a3942] text-[14px] font-medium text-[#54656f] dark:text-[#aebac1] hover:bg-[#f8f9fa] dark:hover:bg-[#182329] transition-colors"
      >
