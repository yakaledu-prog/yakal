...
export default function Navbar({ onNav }: { onNav: (id: string) => void }) {
  ...
  return (
    <div className="flex items-center justify-between w-full mb-[20px] md:mb-[397px]">
      ...
      {/* Mobile dropdown */}
      {menuOpen && (
        <div className="md:hidden absolute top-0 pt-[14px] left-0 right-0 z-10 bg-black/50 backdrop-blur-sm rounded-[20px] flex flex-col py-[16px] px-[24px] gap-[4px] h-full">
          {links.map((l) => (
