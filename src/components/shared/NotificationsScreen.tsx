        ...
        <div className="bg-primary text-white pt-6 px-6 pb-6 md:pt-8 md:px-8 relative overflow-hidden shrink-0">
          ...
          <div className="relative z-10 flex flex-wrap items-end justify-between gap-4">
            ...
            <div className="flex items-center gap-6 md:gap-8">
              {/* Asking for permission has to come from a click, so it lives on
                  the screen somebody opens when they are already thinking
                  about notifications rather than firing on a page load. A
                  browser holds a refused prompt against the origin, so there
                  is one chance at it. */}
