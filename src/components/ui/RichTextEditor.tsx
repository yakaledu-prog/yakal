  ...
  return (
    <div
      className={cn(
        ...
        "[&_h1]:text-xl [&_h1]:font-medium [&_h1]:mb-2 [&_h2]:text-lg [&_h2]:font-medium [&_h2]:mb-2 [&_h3]:text-base [&_h3]:font-medium [&_h3]:mb-2",
        "[&_p]:mb-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-2 [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:mb-2",
        "[&_a]:text-primary [&_a]:underline [&_strong]:font-medium",
        className
      )}
