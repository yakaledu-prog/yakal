...
export function PrivacyPolicyPage() {
  return (
    <>
      <Seo title="Privacy policy" description="What Yakal collects, why, and what families can ask us to delete." />
      ...
      <div className="flex flex-col md:flex-row min-h-screen md:h-screen md:overflow-hidden bg-background dark:bg-[#111b21]">
        ...
        <div className="flex-1 w-full p-6 md:p-12 lg:p-16 md:overflow-y-auto">
          <div className="prose prose-sm md:prose-base dark:prose-invert max-w-3xl text-[#111] dark:text-[#d1d5db]">
            ...
            <h3 className="text-xl font-medium text-primary mb-2 mt-0">1. Information We Collect</h3>
            <p className="mb-8">
              We collect information you provide directly to us, such as when you create or modify your account, request on-demand services, contact customer support, or otherwise communicate with us.
            </p>

            <h3 className="text-xl font-medium text-primary mb-2">2. How We Use Information</h3>
            <p className="mb-8">
            ...
            <h3 className="text-xl font-medium text-primary mb-2">3. Sharing of Information</h3>
            <p className="mb-8">
            ...
            <h3 className="text-xl font-medium text-primary mb-2">4. Data Security</h3>
            <p className="mb-8">
