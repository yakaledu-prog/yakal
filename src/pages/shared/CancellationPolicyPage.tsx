      ...
      <div className="flex flex-col md:flex-row min-h-screen md:h-screen md:overflow-hidden bg-background dark:bg-[#111b21]">
        ...
        <div className="flex-1 w-full p-6 md:p-12 lg:p-16 md:overflow-y-auto">
          <div className="prose prose-sm md:prose-base dark:prose-invert max-w-3xl text-[#111] dark:text-[#d1d5db]">
            ...
            <h3 className="text-xl font-medium text-primary mb-2 mt-0">1. General Policy</h3>
            <p className="mb-8">
            ...
            <h3 className="text-xl font-medium text-primary mb-2">2. Session Cancellation</h3>
            ...
            <h3 className="text-xl font-medium text-primary mb-2">3. Rescheduling Policy</h3>
            <ul className="list-disc pl-5 mb-8 space-y-2">
            ...
            <h3 className="text-xl font-medium text-primary mb-2">4. Emergency Cancellations</h3>
            <p className="mb-8">
            ...
            <h3 className="text-xl font-medium text-primary mb-2">5. Tutor Cancellations</h3>
            <ul className="list-disc pl-5 mb-8 space-y-2">
            ...
            <h3 className="text-xl font-medium text-primary mb-2">6. Payment and Refunds</h3>
            <ul className="list-disc pl-5 mb-8 space-y-2">
            ...
            <h3 className="text-xl font-medium text-primary mb-2">7. Policy Acknowledgment</h3>
            <p className="mb-4">
              By scheduling sessions with Yakal Education Services, clients acknowledge and agree to this cancellation policy.
            </p>
            <p className="mb-0">
              For any questions or concerns regarding this policy, please contact us at <a href="mailto:info@yakal.com" className="text-primary hover:underline">info@yakal.com</a>.
            </p>
          </div>
        </div>
