      ...
      <div className="flex shrink-0 items-center gap-5">
        {hasChanges && (
          <button
            ...
            disabled={isSaving}
            className="flex items-center gap-1.5 text-[13px] font-normal text-muted-foreground transition-colors hover:text-foreground disabled:opacity-50"
          >
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-[13px] font-medium text-[#1099A1] transition-colors hover:text-[#0d7f86] disabled:opacity-40"
        >
