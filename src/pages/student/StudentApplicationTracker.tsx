        ...
        <div className="bg-[#1099A1] text-white p-6 md:p-10">
          <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-white/80 text-[15px] mt-1">Every school, every requirement</p>
            </div>
          </div>
        </div>
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="border border-[#e9edef] dark:border-[#2a3942] p-4 bg-white dark:bg-[#182229]">
                  ...
                  <p className="text-[13px] text-muted-foreground mt-1">Submitted</p>
                </div>
                <div className="border border-[#e9edef] dark:border-[#2a3942] p-4 bg-white dark:bg-[#182229]">
              ...
              {/* Academics & Documents */}
              <div>
                <h2 className="text-[15px] font-bold uppercase tracking-wider mb-2 text-foreground">Academics & documents</h2>
