        ...
        <div className="bg-[#1099A1] text-white p-6 md:p-10">
          <div className="max-w-[1100px] mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-white/80 text-[15px] mt-1">Research, compare & track every school</p>
            </div>
          </div>
        </div>
            ...
            <>
              ...
              <div>
                <p className="text-[15px] text-foreground leading-relaxed">
                  Build a balanced list of Dream, Target and Safety schools — with deadlines, essays, cost, aid, fit and the numbers, all in one place.
                </p>
              </div>

              {/* Stats Grid */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="border border-[#e9edef] dark:border-[#2a3942] p-4 bg-white dark:bg-[#182229]">
                  <p className="text-2xl font-bold">{dreamCount}</p>
                  <p className="text-[13px] text-muted-foreground mt-1">Dream / Reach</p>
                </div>
                <div className="border border-[#e9edef] dark:border-[#2a3942] p-4 bg-white dark:bg-[#182229]">
                  <p className="text-2xl font-bold">{targetCount}</p>
                  <p className="text-[13px] text-muted-foreground mt-1">Target / Match</p>
                </div>
                <div className="border border-[#e9edef] dark:border-[#2a3942] p-4 bg-white dark:bg-[#182229]">
                  <p className="text-2xl font-bold">{safetyCount}</p>
                  <p className="text-[13px] text-muted-foreground mt-1">Safety</p>
                </div>
                <div className="border border-[#e9edef] dark:border-[#2a3942] p-4 bg-white dark:bg-[#182229]">
                  <p className="text-2xl font-bold">{schools.length}</p>
                  <p className="text-[13px] text-muted-foreground mt-1">Schools</p>
                </div>
              </div>

              {/* Actions */}
              <div className="flex flex-wrap items-center gap-3 border-b border-[#e9edef] dark:border-[#2a3942] pb-4">
                <button className="px-4 py-2 border border-[#e9edef] dark:border-[#2a3942] text-[13px] font-semibold hover:bg-muted/50 transition-colors">Compare</button>
                <button className="px-4 py-2 border border-[#e9edef] dark:border-[#2a3942] text-[13px] font-semibold hover:bg-muted/50 transition-colors">Export CSV</button>
