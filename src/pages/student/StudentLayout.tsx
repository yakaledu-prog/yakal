...
import { Home, Calendar, CheckSquare, BookOpen, MessageSquare, Bell, History, Library } from "lucide-react";
...
export function StudentLayout() {
  const navItems = [
    ...
    { name: "Messages", href: "/student/messages", icon: <MessageSquare size={20} /> },
