            ...
            <>
              ...
              <div>
                <p className="text-[15px] text-foreground leading-relaxed">
                  A year-by-year plan for high school — coursework, testing, essays, applications, and financial aid. Built for the admissions journey, separate from K-12 tutoring.
                </p>
              </div>
