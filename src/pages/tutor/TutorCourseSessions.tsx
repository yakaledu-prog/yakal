...
export function TutorCourseSessions() {
  const sessions = [
    {
      ...
      <div className="flex-1 flex flex-col h-full border-b md:border-b-0 md:border-r border-[#e9edef] dark:border-[#2a3942] bg-white dark:bg-[#202c33] overflow-y-auto">
        ...
        <div className="p-8">
          ...
          <p className="text-[14px] text-[#54656f] dark:text-[#aebac1] leading-relaxed">
            In this recorded live session, we went over the basics of algebraic variables and solved several examples from the textbook. Tutors asked great questions regarding constant coefficients.
          </p>
        </div>
      </div>
