...
function EditModal({ onClose }: { onClose: () => void }) {
  ...
  const input =
    "w-full rounded-lg border border-[#e9edef] bg-transparent px-3 py-2.5 text-[14px] text-[#111] outline-none transition-colors placeholder:text-[#9aa5ab] focus:border-primary dark:border-[#2a3942] dark:text-white";
