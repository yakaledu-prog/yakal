      ...
      <div className="max-w-[1440px] mx-auto px-[24px] md:px-[73px] py-[40px]">
        ...
        <div className="flex flex-col lg:flex-row gap-[40px] lg:gap-[80px] items-start">
          ...
          <div className="flex-1 w-full pt-0 lg:pt-[10px]">
            {/* Header */}
            <h1 className="text-[32px] md:text-[48px] font-bold leading-[1.1] text-[#111] mb-[32px] md:mb-[48px] tracking-tight">{currentSubject.name}</h1>

            {/* Clean Minimal Tabs (Option A) */}
            {hasMultipleCourses && (
              <div className="flex flex-wrap gap-[8px] md:gap-[12px] my-[32px] md:mb-[40px]">
