...
export function ParentCollege() {
  ...
  return (
    <PageWrapper className="!p-0">
      {isLoading ? (
        <div className="flex-1 min-h-screen bg-background dark:bg-[#111b21] flex justify-center py-16">
          <Loader2 className="animate-spin text-[#1099A1]" />
        </div>
      ) : children.length === 0 ? (
        <div className="flex-1 min-h-screen bg-background dark:bg-[#111b21] text-center py-16 text-[#8696a0]">
        ...
        <CollegeProfilePanel
          ...
          renderHeader={(tabsNode) => (
            <div className="bg-[#1099A1] text-white pt-6 px-6 md:pt-10 md:px-10 pb-0">
