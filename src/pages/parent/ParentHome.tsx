                    ...
                    >
                      <div
                        className={cn(
                          ...
                          i === 0
                            ? "-left-[7px] top-1.5 h-3 w-3 bg-primary shadow-[0_0_0_4px_rgba(16,153,161,0.2)]"
  ...
  return (
    <div className="group flex flex-col sm:flex-row sm:items-center justify-between py-5 border-b border-border/40 last:border-0 hover:bg-muted/10 transition-colors px-2 -mx-2 rounded-lg cursor-default">
      <div className="flex items-center gap-4">
        <div className="hidden md:block lg:block w-1.5 h-1.5 rounded-full bg-muted-foreground/30 group-hover:bg-primary transition-colors" />
