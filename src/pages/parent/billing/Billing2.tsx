...
export function Billing2() {
  ...
  const left = packages.reduce((n, p) => n + p.slotsUnscheduled, 0);
      ...
      <div className="flex h-full min-h-0 flex-col overflow-y-auto bg-background md:flex-row md:overflow-hidden">
        ...
        <section className="min-w-0 flex-1 md:h-full md:overflow-y-auto">
          <div className="mx-auto max-w-[860px] p-6 md:p-8">
            ...
            {/* The two facts worth knowing before anything else. */}
            <div className="mt-4 flex flex-wrap gap-8 border-b border-border pb-6">
              <div>
                <p className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">
                  Sessions left to schedule
                </p>
                <p className="mt-1 text-[26px] font-medium leading-none text-foreground">{left}</p>
              </div>
              <div>
                <p className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">
                  Paid to date
