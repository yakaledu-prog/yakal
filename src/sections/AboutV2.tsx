...
export default function AboutV2() {
  return (
    <div id="about-v2" className="w-full flex flex-col gap-[80px] md:gap-[160px] py-[60px] md:py-[100px] items-center bg-[#fafafa]">
      
      {/* V2 Header Badge */}
      <div className="w-full max-w-[1440px] px-[24px] md:px-[73px]">
         <div className="inline-block bg-[#1099A1] text-white px-4 py-1 text-sm font-bold tracking-widest uppercase mb-4">
