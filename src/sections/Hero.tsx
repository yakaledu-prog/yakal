  ...
  return (
    <div id="home" className="relative rounded-[20px] md:rounded-[30px] w-full max-w-[1440px]">
      <div className="absolute inset-0 pointer-events-none rounded-[20px] md:rounded-[30px]">
        ...
        <div className="absolute bg-gradient-to-r from-black/80 via-black/40 to-transparent inset-0 rounded-[20px] md:rounded-[30px]" />
      </div>
      ...
      <div className="relative flex flex-col items-start py-[20px]">
        ...
        <div className="max-w-[700px] pt-[60px] md:pt-[120px] pb-[60px] md:pb-[140px] px-[24px] md:px-[73px]">
          ...
          <button onClick={() => window.open('https://calendly.com/binyammamo01/parent-counseling-session', '_blank')} className="btn-shimmer px-[25px] md:px-[35px] py-[12px] md:py-[15px] rounded-[500px] text-white text-[14px] md:text-[16px] uppercase shadow-lg hover:opacity-90 transition-opacity">
